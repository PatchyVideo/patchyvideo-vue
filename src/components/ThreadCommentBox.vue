<template>
  ...
  >
    ...
    <div class="comment-box">
      <div class="title-div">
        <p class="title">
          <span>{{ commentAuthorsInfo[comment.meta.created_by.$oid] ? commentAuthorsInfo[comment.meta.created_by.$oid].profile.username : "loading..." }}</span
        ...
        <div v-if="!comment.hidden && this.$store.state.username" class="comment-bar">
          <i
