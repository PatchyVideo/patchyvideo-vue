        ...
        <div class="minibox">
            ...
            <div class="m_a activeTag">
                ...
                <ul class="Taglist Copyright">
                    ...
                    <li class="item" v-for="(i,item) in TagCategoriesData"
                        :key="item"
                        v-if="i=='Copyright'"
                ...
                <ul class="Taglist General">
                    <li class="item" v-for="(i,item) in TagCategoriesData":key="item" v-if="i=='General'":class="{selected:-1==tagsForRec.indexOf(item)}" @click.stop="selected(i,item)">
                        <p class="val_${str[i]}">{{item}}</p>
                        <i class="fa fa-close" @click.stop="deleteObj(i,item)"></i>
                    </li>
                </ul>
                <ul class="Taglist Meta">
                    <li class="item" v-for="(i,item) in TagCategoriesData":key="item" v-if="i=='Meta'":class="{selected:-1==tagsForRec.indexOf(item)}" @click.stop="selected(i,item)">
                        <p class="val_${str[i]}">{{item}}</p>
                        <i class="fa fa-close" @click.stop="deleteObj(i,item)"></i>
                    </li>
                </ul>
                <ul class="Taglist Author">
                    <li class="item" v-for="(i,item) in TagCategoriesData":key="item" v-if="i=='Author'":class="{selected:-1==tagsForRec.indexOf(item)}" @click.stop="selected(i,item)">
                        <p class="val_${str[i]}">{{item}}</p>
                        <i class="fa fa-close" @click.stop="deleteObj(i,item)"></i>
                    </li>
                 </ul>
            ...
            <div class="m_b">
                ...
                <div id="m_b_box">
                    ...
                    <input id="ipt" v-model="iptVal" @focus="infoTipEvent(true)"@blur="infoTipEvent(false)">
